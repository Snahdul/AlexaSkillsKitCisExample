...
WORKDIR /src
COPY ["AlexaSkillsKitCisExample.csproj", "AlexaSkillsKitCisExample/"]
RUN dotnet restore "AlexaSkillsKitCisExample/AlexaSkillsKitCisExample.csproj"

WORKDIR "/src/AlexaSkillsKitCisExample"
COPY . .
RUN dotnet build "AlexaSkillsKitCisExample.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AlexaSkillsKitCisExample.csproj" \
...
Execute unit tests
```
cd "AlexaSkillsKitCisExample/test/AlexaSkillsKitCisExample.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "AlexaSkillsKitCisExample/src/AlexaSkillsKitCisExample"
